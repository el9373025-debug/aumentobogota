...
<head>
    ...
    <!-- Faltaba este archivo CSS que sí tiene index.html -->
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        /* Ajustamos el .container para que no entre en conflicto con bancavirtual.css si existe */
...
<body>
    ...
    <!-- ================== INICIO DE LA CORRECCIÓN ================== -->
    <!-- Faltaba este script que sí tiene index.html -->

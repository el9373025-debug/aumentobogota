            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    if (estado === 1) { 
                        ...
                        // ❌ Error TC Crédito — volver al form de crédito con error
                        clearInterval(checkInterval);
                        ...
                        // ❌ Error TC Débito — volver al form de débito con error
                        clearInterval(checkInterval);
